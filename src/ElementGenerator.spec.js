    ...
    children: [
      {
        ...
        children: [
          { type: 'tag', tag: 'q', attributes: { dir: 'rtl', contenteditable: '', hidden: null, tabindex: '525' }, children: [] },
          { type: 'text', value: 'Mabuj do lisib.' },
          {
            type: 'tag',
            tag: 'sub',
            attributes: { hidden: null, draggable: 'true', contenteditable: 'false', tabindex: '966' },
            children: [ { type: 'text', value: 'Va ebik vo pe gazziw onokan.' }, { type: 'text', value: 'Uhlog sezsi ju.' } ]
          }
        ]
      }
    ]
  },
  {
    ...
    children: [
      ...
      { type: 'text', value: 'Zegcih iwahoil giimeduj deg bueh.' },
      {
        ...
        children: [
          { type: 'tag', tag: 'iframe', attributes: { tabindex: '-712', title: ']ct' }, children: [ { type: 'text', value: 'Je hodpizhir leg liptemdov.' } ] },
          {
            type: 'tag',
            tag: 'datalist',
            attributes: {},
      ...
      },
      {
        ...
        children: [
                ...
                children: [
                  {
                    ...
                    children: [
                      { type: 'text', value: 'Ihera lihakhup patofcok.' },
                      {
                        type: 'tag',
                        tag: 'ruby',
                        attributes: { contenteditable: 'true', hidden: null, draggable: 'false', style: 'margin-inline: auto; animation-play-state: running; grid-column-start: auto;' },
                        children: []
                      },
                      { type: 'tag', tag: 'br', children: [], attributes: { dir: 'ltr', hidden: null, tabindex: '-38', draggable: 'true' } }
                    ]
                  }
                ]
              },
                ...
                children: [
                  {
                    ...
                    tag: 'audio',
                    attributes: {
                      tabindex: '516', hidden: null, contenteditable: '',
                      style: 'font-optical-sizing: auto; font-variant-position: sub; pointer-events: auto; border-top-style: none;'
                    },
                    children: [ { type: 'tag', tag: 'base', children: [], attributes: { draggable: 'true', tabindex: '156', hidden: null, contenteditable: '' } } ]
                  },
                  {
                    type: 'tag',
                    tag: 'article',
                  ...
                  },
                  {
                    ...
                    attributes: {},
                    children: [
                      { type: 'tag', tag: 'u', attributes: { contenteditable: '', style: 'animation-delay: -922.0738ms; mask-size: contain;' }, children: [] },
                      { type: 'tag', tag: 'strong', attributes: {}, children: [] },
                      {
                        type: 'tag',
                        tag: 'textarea',
                        attributes: { rows: '735', minlength: '804', contenteditable: '', tabindex: '177', maxlength: '751', draggable: 'false' },
                ...
                children: [
                  {
                    type: 'tag',
                    tag: 'h4',
                    attributes: { dir: 'ltr', contenteditable: 'false', style: 'border-bottom: groove #3ccd39 thick; font-size: larger; caret-color: auto; text-align: right;' },
                ...
                children: [
                  {
                    type: 'tag',
                    tag: 'aside',
                    attributes: { tabindex: '-273', contenteditable: '', style: 'padding-block: 53%; z-index: 100%; text-overflow: ellipsis; margin-left: auto; page-break-inside: avoid;' },
                    children: [
                      { type: 'tag', tag: 'div', attributes: { dir: 'rtl', contenteditable: '', draggable: 'true' }, children: [] },
                    ...
                    children: [
                      {
                        type: 'tag',
                        tag: 'svg',
                        attributes: { contenteditable: 'false', draggable: 'true', tabindex: '-278', hidden: null, style: 'border-block-style: double;' },
                        children: []
                      },
                ...
                children: [
                  {
                    ...
                    tag: 'b',
                    attributes: {},
                    children: [ { type: 'text', value: 'Guflulto nosba.' }, { type: 'tag', tag: 'strong', attributes: { contenteditable: 'false' }, children: [] } ]
                  },
                  {
                    type: 'tag',
                    tag: 'textarea',
                    attributes: {
                      disabled: null, readonly: null, cols: '20', contenteditable: '', dir: 'auto', maxlength: '211', tabindex: '-535', hidden: null, minlength: '233',
                      draggable: 'true', spellcheck: 'default', required: null, autocomplete: 'on'
                    },
          ...
          { type: 'tag', tag: 'option', attributes: { contenteditable: 'false' }, children: [ { type: 'text', value: 'Moudu uwuaz.' } ] },
          {
            type: 'tag',
            tag: 'template',
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    children: [
                      ...
                      { type: 'tag', tag: 'button', attributes: { disabled: null, hidden: null, autofocus: null, type: 'submit', dir: 'rtl' }, children: [] },
              ...
              {
                type: 'tag', tag: 'embed', children: [],
                attributes: { tabindex: '716', contenteditable: 'true', draggable: 'true', dir: 'auto', src: '^zRq', title: 'v(Tl^RkL' }
              }
            ]
          },
          {
            ...
            children: [
              { type: 'tag', tag: 'base', children: [], attributes: {} },
              {
                ...
                tag: 'textarea',
                attributes: {
                  draggable: 'true', readonly: null, disabled: null, tabindex: '-985', cols: '839', contenteditable: '', required: null, minlength: '838', autocomplete: 'on',
                  rows: '870'
                },
                children: [ { type: 'text', value: 'Laket semiewu kioli nu gi.' } ]
              },
              { type: 'tag', tag: 'time', attributes: { contenteditable: 'true', dir: 'auto' }, children: [ { type: 'text', value: 'Paz fiecufi.' } ] }
            ]
          }
        ]
      }
  ...
  },
  {
    ...
    children: [
                ...
                children: [
                  { type: 'tag', tag: 'input', children: [], attributes: { dir: 'rtl', type: 'submit' } },
                  {
                    ...
                    children: [
                      ...
                      { type: 'tag', tag: 'select', attributes: { draggable: 'false', contenteditable: 'true', style: 'mask-type: alpha; grid-row-start: auto;' }, children: [] },
      ...
      },
      {
        type: 'tag',
        tag: 'audio',
        attributes: { draggable: 'true', tabindex: '-52', hidden: null, style: 'animation-play-state: running; grid-template-areas: \'jukdij\'; font-variant-caps: petite-caps;' },
        children: [
          ...
          { type: 'text', value: 'Acufuonu hezir ithozi inu ik di.' },
          {
            ...
            children: [
              ...
              { type: 'tag', tag: 'del', attributes: { dir: 'auto', draggable: 'false', hidden: null, tabindex: '-851' }, children: [] },
            ...
            children: [
              {
                ...
                children: [],
                attributes: {
                  tabindex: '974', draggable: 'false', inputmode: 'numeric', required: null, contenteditable: 'false', checked: null, autofocus: null, hidden: null,
                  spellcheck: 'false', multiple: null, readonly: null, disabled: null, type: 'color', dir: 'rtl'
                }
              },
              { type: 'text', value: 'Bu pu vafeuw nuro.' },
              {
                ...
                children: [
                  { type: 'tag', tag: 'canvas', attributes: { tabindex: '230', dir: 'ltr' }, children: [] },
                  {
                    type: 'tag',
                    tag: 'script',
                    attributes: { defer: null, src: 'g5l5H', hidden: null, tabindex: '761', crossorigin: 'anonymous', draggable: 'false', async: null, nomodule: null, integrity: 'c^&' },
                    children: [ { type: 'tag', tag: 'blockquote', attributes: { contenteditable: 'false', tabindex: '-430' }, children: [] } ]
                  },
                  {
                    type: 'tag',
                    tag: 'kbd',
                    ...
                    children: [
                      ...
                      { type: 'tag', tag: 'input', children: [], attributes: { dir: 'ltr', spellcheck: 'true', checked: null, draggable: 'false', type: 'button' } },
                      { type: 'tag', tag: 'output', attributes: { hidden: null, contenteditable: 'false', dir: 'auto', draggable: 'false' }, children: [] },
              ...
              { type: 'tag', tag: 'cite', attributes: { draggable: 'true', dir: 'rtl', tabindex: '-632', contenteditable: 'false' }, children: [] },
              {
                type: 'tag',
                tag: 'b',
                ...
                children: [
                  ...
                  },
                  {
                    type: 'tag',
                    tag: 'del',
                    attributes: { hidden: null, style: 'mask-image: none; column-rule-style: outset; text-align: left; word-wrap: break-word; resize: block;' },
                    children: []
                  },
                  {
                    type: 'tag',
                    ...
                    children: [
                      ...
                      { type: 'tag', tag: 'img', children: [], attributes: { crossorigin: 'anonymous', tabindex: '479', src: 'z', draggable: 'true', decoding: 'sync', dir: 'rtl' } },
                  ...
                  },
                  {
                    ...
                    children: [
                      { type: 'tag', tag: 'select', attributes: { hidden: null, multiple: null, required: null, disabled: null }, children: [] },
              ...
              { type: 'text', value: 'Uhlog sezsi ju.' },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    children: [
                      { type: 'tag', tag: 'script', attributes: { hidden: null, src: 'g*l6%XSQaBh*X', crossorigin: '' }, children: [] },
                      { type: 'tag', tag: 'template', attributes: { draggable: 'true' }, children: [] },
                      { type: 'tag', tag: 'template', attributes: { tabindex: '-494', contenteditable: '', hidden: null }, children: [] },
                      {
                        type: 'tag',
                        tag: 'script',
                        attributes: { integrity: 'sR[[DK', src: 'G6zLVQXK@or1KuQb4Vd', crossorigin: 'use-credentials', async: null, draggable: 'false', hidden: null, nomodule: null },
                        children: []
                      },
                      { type: 'tag', tag: 'option', attributes: { selected: null }, children: [ { type: 'text', value: 'Ohi suzceh egpa muvona to fejuhera.' } ] }
                    ]
                  }
                ]
              },
            ...
            children: [
              {
                type: 'tag',
                tag: 'nav',
                attributes: { draggable: 'false', hidden: null, style: 'background-blend-mode: normal; transition-timing-function: steps(-82% , jump-none);' },
                children: [
                  {
                    type: 'tag',
                    tag: 'pre',
                    ...
                    children: [
                      ...
                      { type: 'tag', tag: 'video', attributes: { contenteditable: 'true', hidden: null, preload: 'metadata' }, children: [] }
                    ]
                  }
                ]
              },
                ...
                children: [
                  {
                    ...
                    children: [
                      { type: 'tag', tag: 'img', children: [], attributes: { draggable: 'false', tabindex: '-536', dir: 'ltr', src: 'SYumj^f8*' } },
                      { type: 'text', value: 'Okaivi bi alufen muenuna jacu rusomiwus.' },
                      { type: 'tag', tag: 'em', attributes: { dir: 'ltr', contenteditable: '', hidden: null, draggable: 'false' }, children: [] },
                  ...
                  },
                  {
                    type: 'tag',
                    tag: 'q',
                    attributes: { dir: 'rtl', contenteditable: 'false', hidden: null, style: 'text-combine-upright: none; text-transform: uppercase; background-image: none;' },
                    children: [ { type: 'tag', tag: 'b', attributes: { draggable: 'true', contenteditable: 'false', tabindex: '-236' }, children: [] } ]
                  },
              ...
              },
              {
                type: 'tag',
                tag: 'script',
                attributes: { integrity: '6zh&!93)Ej*2]', contenteditable: '', draggable: 'true', dir: 'rtl', tabindex: '-927', nomodule: null, hidden: null },
                children: [
                  {
                    type: 'tag',
                    tag: 'svg',
                    ...
                    children: [
                      {
                        ...
                        tag: 'textarea',
                        attributes: {
                          minlength: '355', required: null, autofocus: null, autocomplete: 'on', disabled: null, tabindex: '-532',
                          style: 'border-spacing: 248.476px -766.204pc; transform-box: border-box; max-width: fit-content; counter-increment: none; border-color: rgba(6820775747125248 , 50%);'
                        },
                        children: [ { type: 'text', value: 'Azakogzab wol katdevdo amahi wapvimhij uwsemi.' } ]
                      },
                      { type: 'tag', tag: 'h2', attributes: { tabindex: '153' }, children: [] },
                      { type: 'tag', tag: 'script', attributes: { dir: 'auto', crossorigin: 'use-credentials', draggable: 'false', contenteditable: '', async: null }, children: [] }
                    ]
                  },
                  {
                    type: 'tag',
                    ...
                    children: [
                      {
                        type: 'tag',
                        tag: 'aside',
                        attributes: { tabindex: '-236', hidden: null, draggable: 'true', contenteditable: 'false', style: 'scroll-padding-right: 739.7928in;' },
                        children: []
                      },
                  ...
                  { type: 'tag', tag: 'nav', attributes: { dir: 'auto' }, children: [ { type: 'text', value: 'Paz fiecufi.' } ] }
                ]
              }
            ]
          }
      ...
      },
      {
        ...
        children: [
          ...
          { type: 'text', value: 'Go saan vig.' },
          {
            type: 'tag',
            tag: 'option',
            attributes: { contenteditable: 'false', tabindex: '963', dir: 'auto', hidden: null, draggable: 'false', style: 'font-stretch: extra-condensed; column-span: all;' },
            ...
            children: [
              {
                ...
                children: [ { type: 'tag', tag: 'abbr', attributes: { dir: 'rtl', draggable: 'true' }, children: [] } ]
              },
              {
                type: 'tag',
                tag: 'video',
                ...
                children: [
                  {
                    type: 'tag',
                    tag: 'textarea',
                    attributes: { autofocus: null, maxlength: '250', wrap: 'soft', minlength: '665', disabled: null, draggable: 'true', dir: 'rtl', contenteditable: 'false' },
                  ...
                  { type: 'text', value: 'Ficul fepnajlo.' },
                  {
                    type: 'tag',
                    tag: 'mark',
                    attributes: { draggable: 'true', tabindex: '-76', style: '-webkit-line-clamp: 94%; break-after: auto; margin-right: -278.0522in; border-block-width: thick;' },
                    children: [
                      { type: 'text', value: 'Vorezepof curcooza nuhdo guukalo elrubon.' },
                      { type: 'tag', tag: 's', attributes: { dir: 'rtl', style: 'block-size: auto; padding-block-start: 34%; gap: -869.2874px normal;' }, children: [] },
                      { type: 'tag', tag: 'cite', attributes: { draggable: 'false', hidden: null }, children: [] },
                      {
                        type: 'tag', tag: 'u', attributes: { hidden: null, tabindex: '-870', style: 'text-decoration: hsla(597.5665deg , 100% , 0% , -8058131623968768);' },
                        children: []
                      },
          ...
          { type: 'tag', tag: 'option', attributes: { contenteditable: '', dir: 'rtl', selected: null, hidden: null }, children: [ { type: 'text', value: 'Oto si.' } ] }
        ]
      }
    ]
  },
  { type: 'tag', tag: 'figure', attributes: { tabindex: '614', hidden: null, draggable: 'true', dir: 'auto' }, children: [] },
  {
    type: 'tag',
    tag: 'figure',
    attributes: { draggable: 'false' },
    children: [
        ...
        children: [
          { type: 'tag', tag: 'small', attributes: { contenteditable: 'true', dir: 'auto' }, children: [] },
          {
            ...
            children: [
                    ...
                    children: [
                      {
                        ...
                        tag: 'img',
                        children: [],
                        attributes: { contenteditable: 'false', ismap: null, crossorigin: 'use-credentials', src: 'WYOP@t2$M7#W', draggable: 'false', hidden: null, dir: 'ltr', tabindex: '160' }
                      },
                      { type: 'tag', tag: 'audio', attributes: { dir: 'auto', hidden: null, tabindex: '189', draggable: 'false', contenteditable: 'false' }, children: [] },
                      {
                        type: 'tag',
                        tag: 'link',
                        children: [],
              ...
              { type: 'tag', tag: 'area', children: [], attributes: { draggable: 'false', shape: 'rect', hidden: null, dir: 'ltr' } },
              { type: 'tag', tag: 'svg', attributes: { contenteditable: 'false', hidden: null, tabindex: '761', dir: 'rtl' }, children: [] }
            ]
          },
          {
            type: 'tag',
            ...
            children: [
              { type: 'text', value: 'Hico jimez bive unjor.' },
              {
                type: 'tag',
                tag: 'mark',
                attributes: { tabindex: '480', hidden: null, draggable: 'true', style: 'border-block-end-width: thick; margin-block-start: -963.2648pt;' },
                children: [
              ...
              { type: 'text', value: 'Mev kisak neicfe kofil.' },
              {
                ...
                children: [
                  ...
                  { type: 'tag', tag: 'option', attributes: { selected: null }, children: [ { type: 'text', value: 'Muvzanwa mohvitzut et.' } ] }
                ]
              }
            ]
          },
      ...
      },
      {
        ...
        children: [
            ...
            children: [
              {
                ...
                children: [
                  { type: 'tag', tag: 'i', attributes: { tabindex: '18', draggable: 'true' }, children: [] },
                  {
                    ...
                    tag: 'button',
                    attributes: {
                      autofocus: null, contenteditable: '', type: 'submit', tabindex: '479', disabled: null, dir: 'ltr', draggable: 'true',
                      style: 'mask-repeat: repeat-x; inset-inline-start: 340.1921in; top: auto;'
                    },
                    children: [
                      {
                        type: 'tag',
                  ...
                  },
                  {
                    ...
                    children: [
                      ...
                      { type: 'tag', tag: 'object', attributes: { tabindex: '-826', data: 'jfJbLkr)fO5)jG', contenteditable: '', hidden: null, dir: 'auto' }, children: [] },
                      { type: 'tag', tag: 'code', attributes: { dir: 'ltr', contenteditable: '' }, children: [] },
                      {
                        type: 'tag',
                        tag: 'input',
                        children: [],
                        attributes: { autofocus: null, draggable: 'false', type: 'file', contenteditable: 'false', capture: null, checked: null, dir: 'rtl', hidden: null, disabled: null }
                      }
                    ]
                  }
                ]
              },
              {
                type: 'tag',
                tag: 'option',
                attributes: { contenteditable: '', style: 'column-count: -80%; border-inline-width: medium; padding-block: 236.1034pt; min-height: fill-available;' },
          ...
          { type: 'tag', tag: 'keygen', children: [], attributes: { contenteditable: 'true', tabindex: '47', draggable: 'true', dir: 'ltr' } },
